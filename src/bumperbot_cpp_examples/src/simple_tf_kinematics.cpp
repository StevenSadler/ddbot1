    ...
    , rotations_counter_ (0)
{
    ...
    get_transform_srv_ = create_service<bumperbot_msgs::srv::GetTransform>("get_transform", 
        std::bind(&SimpleTfKinematics::getTransfromCallback, this, _1, _2));
...
bool SimpleTfKinematics::getTransfromCallback(const std::shared_ptr<bumperbot_msgs::srv::GetTransform::Request> req,
